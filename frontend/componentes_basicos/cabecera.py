...
# from ..registro.registro_main import *
# from ..datos_alumno.datosAlumno import *
# from ..datos_profesor.datosProfesor import *
#
#
# class Cabecera(tk.Frame):
#     """
...
#         # self.configure(bg=ProgramConstants.AZUL_MARINO, height=700, width=1366)
#         # Imagen TECNM
